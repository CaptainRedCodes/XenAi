        ...
        <FadeIn className="max-w-3xl mx-auto text-center mb-12">
          ...
          <SlideIn delay={0.2}>
            ...
            <p className="text-lg text-white/70">
              We are committed to transparency and data protection. You are always in control of your data, and can delete your account or export your information at any time. For questions, contact us at <a href="mailto:mdzub7@gmail.com" className="underline text-blue-400">mdzub7@gmail.com</a>.
            </p>
          </SlideIn>
        </FadeIn>
      </div>
